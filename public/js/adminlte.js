  ...
  var e = function (t) {
    ...
    var e = "CardWidget",
      ...
      return i.collapse = function () {
        ...
        n || (n = new e(t(this), n), t(this).data("lte.cardwidget", "string" == typeof i ? n : i)), "string" == typeof i && i.match(/collapse|expand|remove|toggle|maximize|minimize|toggleMaximize/) ? n[i]() : "object" == _typeof(i) && n._init(t(this));
      }, e;
    }();
...
__webpack_require__(/*! /var/www/html/resources/js/adminlte.min.js */"./resources/js/adminlte.min.js");
!(function webpackMissingModule() { var e = new Error("Cannot find module '/var/www/html'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
